...
public class GlobalConstants {
    ...
    public final static String SELECT_COORDINATES = "SELECT ROUND(ABS(x2 - x1)) AS len, COUNT(*) " +
            "AS num FROM coordinates GROUP BY 1 ORDER BY 1";
    public final static String INSERT_FREQUENCIES = "INSERT INTO frequencies (len, num) VALUES (?, ?)";
    public final static String DELETE_FREQUENCIES = "DELETE FROM frequencies";
    public final static String SELECT_FREQUENCIES = "SELECT * FROM frequencies WHERE len > num";
