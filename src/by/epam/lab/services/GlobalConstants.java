...
public class GlobalConstants {
    ...
    public final static String DATE_XML_PATTERN = "yyyy-MM-dd";
    public final static String DATE_STRING_PATTERN = "dd.MM.yyyy";
    public final static String FORMAT_OF_MARK = "%d.%d";
