...
public class TestRunner {
    ...
    @Test
    public void testInsertWrongInd() {
    ...
    @Test
    public void testInsertWrongInd1() {
        final int INDEX = 1000;
        Purchase[] purchaseArr = {
                new Purchase("bread", new Byn(145), 5),
                new Purchase("bread", new Byn(154), 3),
    ...
    public void testGetTotalCost() {
        ...
        PurchaseList purchaseList = new PurchaseList();
        purchaseList.addMassive(purchaseArray);
    ...
    public void testSearchPurchase() throws LineException {
        PurchaseList purchaseList = new PurchaseList(FILE_NAME, new PurchaseComparator());
        Assert.assertEquals(new Purchase("milk", new Byn(131), 2).toString(), purchaseList.binarySearch("milk;131;2").toString());
    }

    @Test
    public void testSearchAbsentPurchase() throws LineException {
        PurchaseList purchaseList = new PurchaseList(FILE_NAME, new PurchaseComparator());
        Assert.assertEquals(null, purchaseList.binarySearch("milk;2131;2"));
    }

    @Test
    public void testPurchaseSort() {
        PurchaseList purchaseList = new PurchaseList(FILE_NAME, new PurchaseComparator());
        Purchase[] sortedPurchaseArray = {
                new Purchase("bread", new Byn(145), 5),
                new Purchase("bread", new Byn(154), 3),
                new PriceDiscountPurchase("bread", new Byn(155), 1, new Byn(2)),
                new PriceDiscountPurchase("butter", new Byn(341), 1, new Byn(1)),
        ...
        expectedPurchaseList.addMassive(sortedPurchaseArray);
        purchaseList.sort();
        Assert.assertEquals(expectedPurchaseList.toString(), purchaseList.toString());
    }
    ...
    public void testRemove() {
        ...
        PurchaseList expectedPurchaseList = new PurchaseList();
        expectedPurchaseList.addMassive(expPurchaseArr);
    ...
    public void testRemove1() {
        ...
        expPurchList.addMassive(expectedPurchaseArray);
