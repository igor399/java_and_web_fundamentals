...
public class TestRunner {
    ...
    public void testEquals() {
        Assert.assertTrue(new Product("Apple", new Byn(30), 15).equals(new Product("Apple", new Byn(30), 15)));
        Assert.assertFalse(new Product("Milk", new Byn(12), 8).equals(new Product("Milk", new Byn(11), 5)));
        Assert.assertFalse(new Product("Apple", new Byn(30), 15).equals(new Product("Milk", new Byn(12), 8)));
    }

    @Test
    public void testGetCost() {
        Assert.assertEquals(new Byn(900), new Product("Apple", new Byn(20), 45).getCost());
    ...
    public void testCreatePurchasesFactory() throws FileNotFoundException {
        ...
        Product[] purchases = new Product[6];
