...
public class TestRunner {
    ...
    public void testGetTotalCost() {
        ...
        PurchaseList purchaseList = new PurchaseList();
        purchaseList.addMassive(sortPurchaseArr);
    ...
    @Test
    public void testSearchPurchase1() throws LineException {
        PurchaseList purchaseList = new PurchaseList(FILE_NAME, new PurchaseComparator());
    ...
    public void testPurchaseSort() {
        ...
        expPurchaseList.addMassive(purchaseArr);
        purchaseList.sort();
    ...
    public void testRemove() {
        ...
        PurchaseList expPurchaseList = new PurchaseList();
        expPurchaseList.addMassive(expPurchaseArr);
    ...
    public void testRemove1() {
        ...
        expPurchList.addMassive(expPurchaseArr);
