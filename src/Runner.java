...
public class Runner {
    public static void main(String[] args) {
        Purchase<Product, Integer> p1 = new Purchase<>(new Product("milk",
                new Byn(170)), 20);
        PurchaseUtils<Product, Integer> pu1 = new PurchaseUtils<>(p1);
        pu1.printPurchase();
        pu1.printCost();
        Purchase<Product, Double> p2 = new Purchase<>(new Product("sugar",
                new Byn(300)), 12.5);
        PurchaseUtils<Product, Double> pu2 = new PurchaseUtils<>(p2);
        pu2.printCost();
        pu2.printCostDiff(p1);
        Purchase<DiscountProduct, Double> p3 = new Purchase<>(new DiscountProduct
