...
для того, чтобы производный не стал в свою очередь абстрактным, компилятор выдаст ошибку), далее можно 
получить ссылку на объект абстрактного суперкласса через объект производного от него.
