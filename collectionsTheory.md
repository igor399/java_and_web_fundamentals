...
**Ответ.**
Basic:  
* Позиционный доступ — манипулирует элементами на основе их числового положения в списке. Сюда входят такие методы, как get, set, add, addAll и remove.  
* Поиск — ищет указанный объект в списке и возвращает его числовую позицию. Методы поиска включают indexOf и lastIndexOf.  
* Итерация — расширяет семантику Iterator, чтобы использовать преимущества последовательного характера списка. Методы listIterator обеспечивают такое поведение.  
